...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nrcbmyi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nrcbmyi.containers.anotherwebservice.com/
...
```
git clone git@github.com:nihitb06/container-nrcbmyi.git
cd container-nrcbmyi
```
...
```
docker attach container-nrcbmyi
```
